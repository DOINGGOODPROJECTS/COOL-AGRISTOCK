                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <h4 class="mb-0"><a href="{{ route('billings.index') }}">{{ moneyFormat($billings->sum('amount')) }}</a></h4>
                                    </div>
                                </div>
                                <div class="mt-3 mb-2">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <h4 class="mb-0"><a href="{{ route('payments.index') }}">{{ moneyFormat($payments->sum('amount')) }}</a></h4>
                                    </div>
                                </div>
                                <div class="mt-3 mb-2">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <h4 class="mb-0"><a href="{{ route('stocks.index') }}">{{ $stocks->count() }}</a></h4>
                                    </div>
                                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-12">
                <div class="card">
                    <div class="card-header justify-content-between">
                        ...
                        <h4 class="card-title">@lang('locale.payment', ['suffix'=>'s']) & @lang('locale.billing', ['suffix'=>''])</h4>
                        <div class="card-addon dropdown"></div>
                    </div>
                    <div class="card-body">
                        <div class="hstack justify-content-center gap-4 pb-3">
                            <div id="graphpayment" style="width: 100%;height:300px;"></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-md-6 col-lg-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="hstack justify-content-center gap-4 pb-3">
                            <div id="graphtemperature" style="width: 100%;height:300px;"></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="hstack justify-content-center gap-4 pb-3">
                            <div id="graphstorage" style="width: 100%;height:300px;"></div>
                        </div>
                    </div>
                </div>
            </div> 
